...
#'
#' - Models with user-sepcified lower or
#'   upper bounds.
#'
#' @return
...
#'
#' @param ptable1 The first `lavaan`
#' parameter table, to be compared with
#' `ptable2`.
#'
#' @param ptable2 The second `lavaan`
...
ptable_to_syntax <- function(fit) {
    # TODOs
    # - Handle unusual labels, e.g., labels with space and operators.
...
compare_ptables <- function(ptable1,
                            ptable2) {
    c0 <- c("lhs", "op", "rhs",
            "group", "free", "ustart",
            "exo", "label", "start",
